...
levels(est$response) <- list("Nitrogen range"="dNr","Total area"="TA","MNND"="MNND","SDNND"="SDNND")
```
...
levels(pp$.id) <- list("Nitrogen range"="dNr","Total area"="TA","MNND"="MNND","SDNND"="SDNND")
...
levels(d_sum_long$.id) <- list("Nitrogen range"="dNr","Total area"="TA","MNND"="MNND","SDNND"="SDNND")
...
g
ggsave("figs/predictions-den.pdf", width = 9.5, height = 5)
